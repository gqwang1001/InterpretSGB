rm(list=ls())
setwd("/SFS/scratch/zhapingy/sim8/code")
source("MySimData_sim8.R")
source("GBTE.R")
source("Myboost.R")
source("OneStep.R")
source("ROWSi.R")
...
MySim <- function(rep){
  ...
  data <- MySimData(N=5500,M=500,enrollment=12,follow=18,lambda0=0.1,p=50,rho=1/3,alpha0=0.4,eta=-log(.9)/12,mu1=-1,mu2=1,mu3=1,mu4=-1,mu0=sqrt(6))
