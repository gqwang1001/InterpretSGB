...
MySimData <-function(N,M,enrollment,follow,lambda0,p,rho,alpha0,eta,mu1,mu2,mu0){
  ...
  sub1 <- (s1>= -1.07 & s1< 1.07) & (s2>= -1.07 & s2< 1.07)
  sub2 <- (s1< -1.07 | s1>= 1.07 | s2< -1.07 | s2>= 1.07)
...
set.seed(2021)
data.simulation <-MySimData(N,M,enrollment,follow,lambda0,p,rho,alpha0,eta,mu1,mu2,mu0)
